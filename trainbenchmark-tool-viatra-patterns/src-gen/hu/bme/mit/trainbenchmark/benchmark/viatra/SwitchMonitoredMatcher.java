 ...
 *
 * <p>Matches of the pattern will be represented as {@link SwitchMonitoredMatch}.
 *
 * <p>Original source:
 * <code><pre>
 ...
 * @see SwitchMonitoredProcessor
 * @see SwitchMonitoredQuerySpecification
 *
 */
...
public class SwitchMonitoredMatcher extends BaseMatcher<SwitchMonitoredMatch> {
   ...
   *
   */
  public static SwitchMonitoredMatcher on(final ViatraQueryEngine engine) throws ViatraQueryException {
  ...
  private final static Logger LOGGER = ViatraQueryLoggingUtil.getLogger(SwitchMonitoredMatcher.class);
   ...
   * @return matches represented as a SwitchMonitoredMatch object.
   *
   */
  public Collection<SwitchMonitoredMatch> getAllMatches(final Switch pSw) {
   ...
   * @param pSw the fixed value of pattern parameter sw, or null if not bound.
   * @return a match represented as a SwitchMonitoredMatch object, or null if no match is found.
   *
   */
  public SwitchMonitoredMatch getOneArbitraryMatch(final Switch pSw) {
   ...
   *
   */
  public void forEachMatch(final Switch pSw, final Consumer<? super SwitchMonitoredMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Switch pSw, final Consumer<? super SwitchMonitoredMatch> processor) {
   ...
   *
   */
  public SwitchMonitoredMatch newMatch(final Switch pSw) {
    return SwitchMonitoredMatch.newMatch(pSw);
  }
   ...
   *
   */
  public static IQuerySpecification<SwitchMonitoredMatcher> querySpecification() throws ViatraQueryException {
