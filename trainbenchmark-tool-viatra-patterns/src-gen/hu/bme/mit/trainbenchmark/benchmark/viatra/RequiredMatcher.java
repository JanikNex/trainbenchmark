...
public class RequiredMatcher extends BaseMatcher<RequiredMatch> {
  ...
  public Collection<RequiredMatch> getAllMatches(final Sensor pSensor, final Route pRoute) {
    return rawStreamAllMatches(new Object[]{pSensor, pRoute}).collect(Collectors.toList());
  }
  ...
  public RequiredMatch getOneArbitraryMatch(final Sensor pSensor, final Route pRoute) {
    return rawGetOneArbitraryMatch(new Object[]{pSensor, pRoute}).get();
  }
   ...
   *
   */
  public void forEachMatch(final Sensor pSensor, final Route pRoute, final Consumer<? super RequiredMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Sensor pSensor, final Route pRoute, final Consumer<? super RequiredMatch> processor) {
