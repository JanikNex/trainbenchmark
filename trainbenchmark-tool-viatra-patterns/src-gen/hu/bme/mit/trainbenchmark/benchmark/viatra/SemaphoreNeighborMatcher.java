...
public class SemaphoreNeighborMatcher extends BaseMatcher<SemaphoreNeighborMatch> {
  ...
  public Collection<SemaphoreNeighborMatch> getAllMatches(final Semaphore pSemaphore, final Route pRoute1, final Route pRoute2, final Sensor pSensor1, final Sensor pSensor2, final TrackElement pTe1, final TrackElement pTe2) {
    return rawStreamAllMatches(new Object[]{pSemaphore, pRoute1, pRoute2, pSensor1, pSensor2, pTe1, pTe2}).collect(Collectors.toList());
  }
  ...
  public SemaphoreNeighborMatch getOneArbitraryMatch(final Semaphore pSemaphore, final Route pRoute1, final Route pRoute2, final Sensor pSensor1, final Sensor pSensor2, final TrackElement pTe1, final TrackElement pTe2) {
    return rawGetOneArbitraryMatch(new Object[]{pSemaphore, pRoute1, pRoute2, pSensor1, pSensor2, pTe1, pTe2}).get();
  }
   ...
   *
   */
  public void forEachMatch(final Semaphore pSemaphore, final Route pRoute1, final Route pRoute2, final Sensor pSensor1, final Sensor pSensor2, final TrackElement pTe1, final TrackElement pTe2, final Consumer<? super SemaphoreNeighborMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Semaphore pSemaphore, final Route pRoute1, final Route pRoute2, final Sensor pSensor1, final Sensor pSensor2, final TrackElement pTe1, final TrackElement pTe2, final Consumer<? super SemaphoreNeighborMatch> processor) {
