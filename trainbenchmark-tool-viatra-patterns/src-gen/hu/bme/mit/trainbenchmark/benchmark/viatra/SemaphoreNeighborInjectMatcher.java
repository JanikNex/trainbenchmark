...
public class SemaphoreNeighborInjectMatcher extends BaseMatcher<SemaphoreNeighborInjectMatch> {
  ...
  public Collection<SemaphoreNeighborInjectMatch> getAllMatches(final Route pRoute, final Semaphore pSemaphore) {
    return rawStreamAllMatches(new Object[]{pRoute, pSemaphore}).collect(Collectors.toList());
  }
  ...
  public SemaphoreNeighborInjectMatch getOneArbitraryMatch(final Route pRoute, final Semaphore pSemaphore) {
    return rawGetOneArbitraryMatch(new Object[]{pRoute, pSemaphore}).get();
  }
   ...
   *
   */
  public void forEachMatch(final Route pRoute, final Semaphore pSemaphore, final Consumer<? super SemaphoreNeighborInjectMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Route pRoute, final Semaphore pSemaphore, final Consumer<? super SemaphoreNeighborInjectMatch> processor) {
