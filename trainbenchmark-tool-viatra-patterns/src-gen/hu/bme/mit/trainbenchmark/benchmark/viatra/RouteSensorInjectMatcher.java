...
public class RouteSensorInjectMatcher extends BaseMatcher<RouteSensorInjectMatch> {
  ...
  public Collection<RouteSensorInjectMatch> getAllMatches(final Route pRoute, final Sensor pSensor) {
    return rawStreamAllMatches(new Object[]{pRoute, pSensor}).collect(Collectors.toList());
  }
  ...
  public RouteSensorInjectMatch getOneArbitraryMatch(final Route pRoute, final Sensor pSensor) {
    return rawGetOneArbitraryMatch(new Object[]{pRoute, pSensor}).get();
  }
   ...
   *
   */
  public void forEachMatch(final Route pRoute, final Sensor pSensor, final Consumer<? super RouteSensorInjectMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Route pRoute, final Sensor pSensor, final Consumer<? super RouteSensorInjectMatch> processor) {
