...
public class PosLengthInjectMatcher extends BaseMatcher<PosLengthInjectMatch> {
   ...
   *
   */
  public void forEachMatch(final Segment pSegment, final Consumer<? super PosLengthInjectMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Segment pSegment, final Consumer<? super PosLengthInjectMatch> processor) {
