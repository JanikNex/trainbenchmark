...
public class SwitchSetMatcher extends BaseMatcher<SwitchSetMatch> {
  ...
  public Collection<SwitchSetMatch> getAllMatches(final Semaphore pSemaphore, final Route pRoute, final SwitchPosition pSwP, final Switch pSw) {
    return rawStreamAllMatches(new Object[]{pSemaphore, pRoute, pSwP, pSw}).collect(Collectors.toList());
  }
  ...
  public SwitchSetMatch getOneArbitraryMatch(final Semaphore pSemaphore, final Route pRoute, final SwitchPosition pSwP, final Switch pSw) {
    return rawGetOneArbitraryMatch(new Object[]{pSemaphore, pRoute, pSwP, pSw}).get();
  }
   ...
   *
   */
  public void forEachMatch(final Semaphore pSemaphore, final Route pRoute, final SwitchPosition pSwP, final Switch pSw, final Consumer<? super SwitchSetMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Semaphore pSemaphore, final Route pRoute, final SwitchPosition pSwP, final Switch pSw, final Consumer<? super SwitchSetMatch> processor) {
