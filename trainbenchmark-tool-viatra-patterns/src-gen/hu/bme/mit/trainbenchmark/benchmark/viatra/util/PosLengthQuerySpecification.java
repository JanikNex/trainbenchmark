      ...
      try {
          {
              ...
              new TypeConstraint(body, Tuples.flatTupleOf(var_segment, var__virtual_0_), new EStructuralFeatureInstancesKey(getFeatureLiteral("http://www.semanticweb.org/ontologies/2015/trainbenchmark", "Segment", "length")));
