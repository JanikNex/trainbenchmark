...
public class RouteSensorMatcher extends BaseMatcher<RouteSensorMatch> {
  ...
  public Collection<RouteSensorMatch> getAllMatches(final Route pRoute, final Sensor pSensor, final SwitchPosition pSwP, final Switch pSw) {
    return rawStreamAllMatches(new Object[]{pRoute, pSensor, pSwP, pSw}).collect(Collectors.toList());
  }
  ...
  public RouteSensorMatch getOneArbitraryMatch(final Route pRoute, final Sensor pSensor, final SwitchPosition pSwP, final Switch pSw) {
    return rawGetOneArbitraryMatch(new Object[]{pRoute, pSensor, pSwP, pSw}).get();
  }
   ...
   *
   */
  public void forEachMatch(final Route pRoute, final Sensor pSensor, final SwitchPosition pSwP, final Switch pSw, final Consumer<? super RouteSensorMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Route pRoute, final Sensor pSensor, final SwitchPosition pSwP, final Switch pSw, final Consumer<? super RouteSensorMatch> processor) {
