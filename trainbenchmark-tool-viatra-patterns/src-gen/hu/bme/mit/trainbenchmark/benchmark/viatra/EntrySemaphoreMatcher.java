...
public class EntrySemaphoreMatcher extends BaseMatcher<EntrySemaphoreMatch> {
   ...
   *
   */
  public void forEachMatch(final Route pRoute, final Semaphore pSemaphore, final Consumer<? super EntrySemaphoreMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Route pRoute, final Semaphore pSemaphore, final Consumer<? super EntrySemaphoreMatch> processor) {
