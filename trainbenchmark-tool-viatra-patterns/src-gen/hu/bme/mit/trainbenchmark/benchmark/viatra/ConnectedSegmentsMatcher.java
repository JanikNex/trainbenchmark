...
public class ConnectedSegmentsMatcher extends BaseMatcher<ConnectedSegmentsMatch> {
  ...
  public Collection<ConnectedSegmentsMatch> getAllMatches(final Sensor pSensor, final Segment pSegment1, final Segment pSegment2, final Segment pSegment3, final Segment pSegment4, final Segment pSegment5, final Segment pSegment6) {
    return rawStreamAllMatches(new Object[]{pSensor, pSegment1, pSegment2, pSegment3, pSegment4, pSegment5, pSegment6}).collect(Collectors.toList());
  }
  ...
  public ConnectedSegmentsMatch getOneArbitraryMatch(final Sensor pSensor, final Segment pSegment1, final Segment pSegment2, final Segment pSegment3, final Segment pSegment4, final Segment pSegment5, final Segment pSegment6) {
    return rawGetOneArbitraryMatch(new Object[]{pSensor, pSegment1, pSegment2, pSegment3, pSegment4, pSegment5, pSegment6}).get();
  }
   ...
   *
   */
  public void forEachMatch(final Sensor pSensor, final Segment pSegment1, final Segment pSegment2, final Segment pSegment3, final Segment pSegment4, final Segment pSegment5, final Segment pSegment6, final Consumer<? super ConnectedSegmentsMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Sensor pSensor, final Segment pSegment1, final Segment pSegment2, final Segment pSegment3, final Segment pSegment4, final Segment pSegment5, final Segment pSegment6, final Consumer<? super ConnectedSegmentsMatch> processor) {
