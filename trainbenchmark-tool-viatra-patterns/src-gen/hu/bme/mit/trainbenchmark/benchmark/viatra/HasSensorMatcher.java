...
public class HasSensorMatcher extends BaseMatcher<HasSensorMatch> {
   ...
   *
   */
  public void forEachMatch(final TrackElement pSw, final Consumer<? super HasSensorMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final TrackElement pSw, final Consumer<? super HasSensorMatch> processor) {
