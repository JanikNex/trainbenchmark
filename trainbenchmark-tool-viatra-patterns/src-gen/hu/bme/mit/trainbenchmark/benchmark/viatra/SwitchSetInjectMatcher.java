...
public class SwitchSetInjectMatcher extends BaseMatcher<SwitchSetInjectMatch> {
   ...
   *
   */
  public void forEachMatch(final Switch pSw, final Consumer<? super SwitchSetInjectMatch> processor) {
   ...
   *
   */
  public boolean forOneArbitraryMatch(final Switch pSw, final Consumer<? super SwitchSetInjectMatch> processor) {
